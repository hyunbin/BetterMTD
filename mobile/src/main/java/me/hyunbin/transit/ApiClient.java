...
public class ApiClient {
  ...
  public Call<GetPlannedTripsByLatLonResponse> getPlannedTripsByLatLon(
      GetPlannedTripsByLatLonParams params) {
    if (params.getTime() != null) {
      return mApiInterface.getPlannedTripsByLatLon(
          params.getOriginLat(),
          params.getOriginLon(),
          params.getDestinationLat(),
          params.getDestinationLon(),
          params.getTime());
    } else {
      return mApiInterface.getPlannedTripsByLatLon(
          params.getOriginLat(),
